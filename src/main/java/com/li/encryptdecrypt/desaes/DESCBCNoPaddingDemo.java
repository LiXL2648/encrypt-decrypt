...
public class DESCBCNoPaddingDemo {

    public static void main(String[] args) throws Exception {

        // 原文
        String text = "李晓亮1234567";
        // 密钥，密钥必须为8字节
        String secret = "12345678";
        // 采用的算法
        // String transformation = "DES";
        // 采用的算法/加密模式/填充模式，加密算法：DES；加密模式：ECB；填充模式：PKCS5Padding。
        // String transformation = "DES/ECB/PKCS5Padding";
        // 采用的算法/加密模式/填充模式，加密算法：DES；加密模式：CBC；填充模式：PKCS5Padding。
        // String transformation = "DES/CBC/PKCS5Padding";
        // 不使用填充模式，如果加密算法是 DES， 原文必须是 8byte 的整数倍
